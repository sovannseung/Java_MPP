...
//		}
		...
		person.stream()
		      .forEach(p -> System.out.println("Name:" + p.getName() + ", Age:" + p.getAge() + ", Type:" + p.getClass().getName()));
...
//		System.out.println("Total number of units they teach:" + total);
			...
			// 3. Use Lambadas
		person.stream()
		      .filter(p -> p.getClass().getSimpleName().equals("Faculty"))
		      .forEach(p -> System.out.println("Faculty name:" + p.getName()));
